    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="display-lg mb-6">
                Understand <span className="text-primary">Transformer</span> Architecture
              </h1>
              ...
              <div className="flex gap-4">
                ...
                >
                  Learn Now <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
      ...
      {activeSection === "overview" && (
        <section className="py-16 bg-secondary/30">
          <div className="container">
            <h2 className="heading-lg mb-12">What is Transformer?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6">
                <Brain className="w-8 h-8 text-primary mb-4" />
                <h3 className="heading-sm mb-3">Neural Network Architecture</h3>
              ...
              <Card className="p-6">
                ...
                <h3 className="heading-sm mb-3">Self-Attention Mechanism</h3>
                <p className="body-sm text-muted-foreground">
              ...
              <Card className="p-6">
                ...
                <h3 className="heading-sm mb-3">Foundation of LLMs</h3>
                <p className="body-sm text-muted-foreground">
      ...
      {activeSection === "architecture" && (
        <section className="py-16">
          <div className="container">
            <h2 className="heading-lg mb-12">Core Components</h2>
            <div className="space-y-8">
              <Card className="p-8">
                <h3 className="heading-md mb-4">1. Embedding Layer</h3>
              ...
              <Card className="p-8">
                <h3 className="heading-md mb-4">2. Self-Attention Mechanism</h3>
                <p className="body-md text-muted-foreground mb-4">
              ...
              <Card className="p-8">
                <h3 className="heading-md mb-4">3. Transformer Blocks</h3>
                <p className="body-md text-muted-foreground mb-4">
      ...
      {activeSection === "timeline" && (
        <section className="py-16 bg-secondary/30">
          <div className="container">
            <h2 className="heading-lg mb-12">Evolution of Transformer Models</h2>
            <img
      ...
      <footer className="border-t border-border py-8 mt-16">
        <div className="container text-center text-sm text-muted-foreground">
          <p>© 2024 Transformer Guide. A beginner-friendly introduction to LLM architecture.</p>
        </div>
      </footer>
    </div>
  );
